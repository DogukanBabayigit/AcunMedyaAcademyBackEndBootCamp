...
class Program
{
    ...
    static void AssaignToTeams(string[] students, string[] teamsNames, double memberCount)
    {
        int teamsCounter = 0;
    ...
    static void Main(string[] args)
    {
        ...
        //Ref kullanarak yaparsak ne olur? **ÖDEV**

        AssaignToTeams(students, teams, memberCount);
    }
}
